...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-paper-23ac
```

A live public deployment of this template is available at [https://nameless-paper-23ac.templates.workers.dev](https://nameless-paper-23ac.templates.workers.dev)
